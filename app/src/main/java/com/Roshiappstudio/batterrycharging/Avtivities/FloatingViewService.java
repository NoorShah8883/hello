...
public class FloatingViewService extends Service {
   ...
   public WindowManager.LayoutParams params;
    ...
    public void onCreate() {
        ...
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.floating_lay, null);
...
//                  WindowManager.LayoutParams.TYPE_PHONE,
        ...
        try{
            LottieAnimationView lotti=mFloatingView.findViewById(R.id.bubblloti1);
            if (mPref.getdefaultlottie1() == 0) {
//         lotti.setAnimation(R.raw.splash2);
            }else {
//        lotti.setAnimation(mPref.getbubbllottie1());
                lotti.setAnimation(mPref.getdefaultlottie1());
                lotti.setRepeatCount(100);
                lotti.playAnimation();
            }

    /*if (mPref.getbool("isAnim")) {
        lotti.setAnimation(mPref.getbubbllottie1());
        lotti.setRepeatCount(100);
        lotti.playAnimation();
